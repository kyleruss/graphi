...
import static com.graphi.display.layout.GraphPanel.PLAYBACK_CARD;
import static com.graphi.display.layout.GraphPanel.RECORD_CARD;
    ...
    private JCheckBox recordComputeCheck, recordStateCheck;
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if(src == gpRecSaveBtn)
                ...
                graphPanel.removeRecordedGraph();

            else if(src == gpRecEntries)
                graphPanel.displayRecordedGraph();
